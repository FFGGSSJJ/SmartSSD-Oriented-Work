...
static const int DATA_SIZE = 40960;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Kernel Execution Time: " << kernel_time/CLOCKS_PER_SEC*1000 << " ms\n";
    std::cout << "CPU Execution Time: " << cpu_time/CLOCKS_PER_SEC*1000 << " ms\n";
